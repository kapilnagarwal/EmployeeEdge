            ...
            >
                <div className="container">
                    <div className={innerClasses}>
                        <SectionHeader data={sectionHeader} headr_side={area} className="center-content" />

                        <div className="row" align="center">
                            <div className="col-sm-6">
                                <button className={area == "customer" ? "client_button_active" : "client_button"} onClick={() => changeArea('client')}> Customer </button>
                            </div>
                            <div className="col-sm-6">
