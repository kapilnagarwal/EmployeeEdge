              ...
              <div className="row">
                <div className="col-sm-12 text_area">
                  ...
                  <div className="row pl-3">
                    ...
                    <div className="col-2">
                      <p className="salary_head"> <i class="fa fa-suitcase" aria-hidden="true"></i> </p>
                      <p className="salary_value"> 10LPA </p>
                    </div>
                    <div className="col-2">
                      <p className="salary_head"> <i class="fa fa-map-marker" aria-hidden="true"></i> </p>
                      <p className="salary_value"> Delhi </p>
                    </div>
                    <div className="col-2">
                      <p className="salary_head"> <i class="fa fa-list-ol" aria-hidden="true"></i> </p>
                      <p className="salary_value"> 1 </p>
                    </div>
                    <div className="col-2">
                      <p className="salary_head"> <i class="fa fa-clock-o" aria-hidden="true"></i> </p>
                      <p className="salary_value"> 1 </p>
                    </div>
