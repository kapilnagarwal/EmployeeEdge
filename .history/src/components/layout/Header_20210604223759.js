...
const Header = ({
  ...
  return (
    <>
      ...
      <Dialog fullScreen open={open} onClose={handleClose} TransitionComponent={Transition} align="center">
        ...
        <div className="row pt-5 ml-3 mr-1" id="job_vacan">
          ...
          <div className="col-sm-3">
            <div className="client_list">
              <div className="row">
                <div className="col-sm-12 job_card">
                  ...
                  <div className="row pl-3">
                    ...
                    <div className="col-12">
                      <p className="salary_head"> salary_head </p>
                    </div>
