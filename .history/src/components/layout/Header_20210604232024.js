      ...
      <Dialog fullScreen open={open} onClose={handleClose} TransitionComponent={Transition} >
        ...
        <div className="row pt-5 ml-1 mr-1" id="job_vacan">
          <div className="col-sm-4">
            <Card className={classes.root} id="job_card">
              <CardContent >
                  <div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-3">
                      <span className="salary_value"> 15 LPA </span>
                    </div>
                    <div className="col-sm-3">
                      <span className="salary_head"> LOCATION </span>
                    </div>
                    <div className="col-sm-3">
                      <span className="salary_value"> DELHI </span>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-3">
                      <span className="salary_value"> +5 </span>
                    </div>
                    <div className="col-sm-3">
                      <span className="salary_head"> QUALIFICATION </span>
                    </div>
                    <div className="col-sm-3">
                      <span className="salary_value"> MCA </span>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-3">
                      <span className="salary_value"> 1-2 year </span>
                    </div>
                  </div>
                  <hr/>
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-12">
                      <span className="salary_value"> Our landing page template works on all devices, so you only have to set it up once, and get beautiful results forever. </span>
                    </div>
                  </div>
                  <hr/>
                  ...
                  <div className="row">
                    <div className="col-sm-6">
                      <button className="read_more" onClick={handleOpenJob}> Read More  </button>
                    </div>
                    <div className="col-sm-6">
                    <button className="apply_button" onClick={handleOpenApply}> Apply Now </button>
                    </div>
                  </div>
              ...
              <CardContent >
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-6 mt-2">
                      <input type="number" className="form-control" name="number" placeholder="Phone" />
                    </div>
                    <div className="col-sm-6 mt-2">
                      <input type="text" className="form-control" name="name" placeholder="Apply Position" />
                    </div>
                    ...
                    <div className="col-sm-6 mt-2">
                      <select class="form-control" id="exampleFormControlSelect1">
                        <option value="state">Selet  State </option>
                    ...
                    <div className="col-sm-12 mt-2">
                      <input type="filter" className="form-control" name="city" placeholder="City" />
                    </div>
